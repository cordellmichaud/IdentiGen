...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--colors", type=int, help="the number of colors from which to create the identicon",
                        default=3)
    parser.add_argument("-min", "--hsvmin", type=double, nargs=3, help="the minimum percentages of hue, saturation, and value "
                                                             "from which to generate colors", default=(0.0, 0.2, 0.2))
    parser.add_argument("-max", "--hsvmax", type=double, nargs=3, help="the maximum percentages of hue, saturation, and value "
